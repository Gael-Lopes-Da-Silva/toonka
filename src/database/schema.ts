import { pgSchema, integer, serial, text, real, boolean, timestamp, index, uniqueIndex } from "drizzle-orm/pg-core"

export const toonka = pgSchema("toonka")

export const bookType = toonka.enum("book_type", ["manga", "manhua", "manhwa"])

export const userBookmarkStatus = toonka.enum("user_bookmark_status", ["reading", "plan_to_read", "on_hold", "dropped", "completed"])
